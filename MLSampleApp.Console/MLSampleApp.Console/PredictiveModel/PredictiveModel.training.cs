...
namespace PredictiveModel.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Projects\MLSampleApp.Console\MLSampleApp.Console\data.csv";
